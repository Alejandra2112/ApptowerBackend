...
const bookingValidationPost = [
    ...
    check('StartTimeBooking')
        ...
        //     const bookingStartDate = moment(body.StartDateBooking).utc().format('YYYY-MM-DD');
        //     const bookingStartTime = moment.utc(`${bookingStartDate} ${body.StartTimeBooking}`, 'YYYY-MM-DD HH:mm');
        //     const bookingEndTime = moment.utc(`${bookingStartDate} ${body.EndTimeBooking}`, 'YYYY-MM-DD HH:mm');

        //     const existingBookings = await BookingModel.findAll({
        //         where: {
        //             idSpace: body.idSpace,
        //             StartDateBooking: bookingStartDate,
        //             [Op.or]: [
        //                 {
        //                     StartTimeBooking: {
